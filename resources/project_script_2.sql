...
INSERT INTO supply_chain (supply_id, storage_id, prod_id, quantity, sold)
VALUES
    ('Supply001', 'Storage001', 'Prod001', 100, 0),
    ('Supply002', 'Storage002', 'Prod002', 50, 0),
    ('Supply003', 'Storage003', 'Prod003', 75, 0),
    ('Supply004', 'Storage004', 'Prod004', 60, 0),
    ('Supply005', 'Storage005', 'Prod005', 90, 0),
    ('Supply001', 'Storage006', 'Prod006', 40, 0),
    ('Supply002', 'Storage007', 'Prod007', 30, 0),
    ('Supply003', 'Storage008', 'Prod008', 80, 0),
    ('Supply004', 'Storage001', 'Prod009', 55, 0),
    ('Supply005', 'Storage002', 'Prod010', 70, 0),
    ('Supply001', 'Storage003', 'Prod011', 65, 0),
    ('Supply002', 'Storage004', 'Prod012', 85, 0),
    ('Supply003', 'Storage005', 'Prod013', 45, 0),
    ('Supply004', 'Storage006', 'Prod014', 95, 0),
    ('Supply005', 'Storage007', 'Prod015', 110, 0),
    ('Supply001', 'Storage008', 'Prod016', 25, 0),
    ('Supply002', 'Storage001', 'Prod017', 120, 0),
    ('Supply003', 'Storage002', 'Prod018', 35, 0),
    ('Supply004', 'Storage003', 'Prod019', 130, 0),
    ('Supply005', 'Storage004', 'Prod020', 75, 0);
...
INSERT INTO customer (cust_id, cust_name, location_id, ph_no)
VALUES
    ...
    ('Cust009', 'Samuel Jackson', 'Loc003', '6667778888'),
    ('Cust010', 'Olivia White', 'Loc001', '2221110000');
...
-- Insert 15 records into the "orders" table with unique order_no and invoice_id, along with repeating cust_id and corrected cust_name
INSERT INTO orders (order_no, ord_date, cust_id, cust_name, storage_id, location_id)
VALUES
    ('Order001', '2023-10-01', 'Cust001', 'John Doe', 'Storage001', 'Loc001'),
    ('Order002', '2023-10-02', 'Cust002', 'Alice Smith', 'Storage002', 'Loc002'),
    ('Order003', '2023-10-03', 'Cust003', 'Bob Johnson', 'Storage003', 'Loc003'),
    ('Order004', '2023-10-04', 'Cust004', 'Emily Davis', 'Storage004', 'Loc004'),
    ('Order005', '2023-10-05', 'Cust005', 'Michael Brown', 'Storage005', 'Loc005'),
    ('Order006', '2023-10-06', 'Cust006', 'Sarah Wilson', 'Storage006', 'Loc006'),
    ('Order007', '2023-10-07', 'Cust007', 'David Lee', 'Storage007', 'Loc007'),
    ('Order008', '2023-10-08', 'Cust008', 'Laura Miller', 'Storage008', 'Loc008'),
    ('Order009', '2023-10-09', 'Cust009', 'Samuel Jackson', 'Storage001', 'Loc001'),
    ('Order010', '2023-10-10', 'Cust001', 'John Doe', 'Storage002', 'Loc002'),
    ('Order011', '2023-10-11', 'Cust002', 'Alice Smith', 'Storage003', 'Loc003'),
    ('Order012', '2023-10-12', 'Cust003', 'Bob Johnson', 'Storage004', 'Loc004'),
    ('Order013', '2023-10-13', 'Cust004', 'Emily Davis', 'Storage005', 'Loc005'),
    ('Order014', '2023-10-14', 'Cust005', 'Michael Brown', 'Storage006', 'Loc006'),
    ('Order015', '2023-10-15', 'Cust010', 'Olivia White', 'Storage007', 'Loc007');
...
INSERT INTO invoice (invoice_id, order_no, cust_id, no_items, total_price, prod_id)
VALUES
    ('Invoice001', 'Order001', 'Cust001', 5, 100, 'Prod009'),
    ('Invoice002', 'Order002', 'Cust002', 3, 50, 'Prod010'),
    ('Invoice003', 'Order003', 'Cust003', 4, 80, 'Prod011'),
    ('Invoice004', 'Order004', 'Cust004', 6, 120, 'Prod012'),
    ('Invoice005', 'Order005', 'Cust005', 2, 40, 'Prod013'),
    ('Invoice006', 'Order006', 'Cust006', 7, 140, 'Prod014'),
    ('Invoice007', 'Order007', 'Cust007', 3, 60, 'Prod015'),
    ('Invoice008', 'Order008', 'Cust008', 4, 80, 'Prod016'),
    ('Invoice009', 'Order009', 'Cust009', 5, 100, 'Prod001'),
    ('Invoice010', 'Order010', 'Cust001', 3, 60, 'Prod002'),
    ('Invoice011', 'Order011', 'Cust002', 4, 80, 'Prod003'),
    ('Invoice012', 'Order012', 'Cust003', 2, 40, 'Prod004'),
    ('Invoice013', 'Order013', 'Cust004', 6, 120, 'Prod005'),
    ('Invoice014', 'Order014', 'Cust005', 5, 100, 'Prod006'),
    ('Invoice015', 'Order015', 'Cust010', 4, 80, 'Prod007');

-- CREATE USER 'customer' IDENTIFIED BY '1234cust';
-- GRANT SELECT ON product TO 'customer';

-- GRANT INSERT, UPDATE ON customer TO 'jack'@'localhost';
